...
class AntennaTfBroadcaster(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(nav_msgs.msg.Odometry, f'/tello1/odom', self.handle_turtle_pose, qos_profile=qos_policy)
    ...
    def generate_antennas(self, **kwargs):
        ...
        for i in range(n_antennas):
            ...
            t.child_frame_id = f"tello1_{antenna_frame_id}_{i}"
    ...
    def handle_turtle_pose(self, msg):
        ...
        self.generate_antennas(n_antennas=4, antenna_frame_id='antenna', parent_frame_id='base_link_1', pose=pose, orientation=orientation)
